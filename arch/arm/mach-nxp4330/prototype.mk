...
obj-$(CONFIG_NEXELL_DISPLAY_LVDS)		+= 	$(PROTOTYPE)/$(MODULES)/nx_lvds.o
obj-$(CONFIG_NEXELL_DISPLAY_RESCONV)	+= 	$(PROTOTYPE)/$(MODULES)/nx_resconv.o
obj-$(CONFIG_NEXELL_DISPLAY_HDMI)		+= 	$(PROTOTYPE)/$(MODULES)/nx_hdmi.o
...
obj-$(CONFIG_NXP4330_BACKWARD_CAMERA)	+=  $(PROTOTYPE)/$(MODULES)/nx_vip.o
