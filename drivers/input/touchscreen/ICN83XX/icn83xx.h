...
#define CTP_IRQ_PORT             PAD_GPIOB25_CABO_ALPHA
#define CTP_IRQ_MODE             0
#define CTP_RST_PORT             PAD_GPIOB24_CABO_ALPHA
...
#define ICN83XX_I2C_SCL          92912 // Hz

// Module Parameters (userspace: /sys/module/icn83xx_ts/parameters/)
static int debug_error = 0;
static int debug_info = 0;
static int debug_point = 0;
static int multibyte_mode = 0;
static int revert_x = 0;
static int revert_y = 0;
static int use_crc = 0; // temporary parameter
...
#define ICN83XX_NAME                "icn83xx"
#define ICN83XX_PROG_IIC_ADDR       (0x60>>1)
#define ICN83XX_NORMAL_IIC_ADDR     (0x80>>1)
