/*
 * NEXELL NXP4330 USB HOST OHCI Controller
 *
...
static const struct hc_driver nxp_ohci_hc_driver = {
	...
	.product_desc		= "NXP4330 OHCI Host Controller",
...
{
	struct nxp4330_ohci_platdata *pdata;
...
{
	struct nxp4330_ohci_platdata *pdata = pdev->dev.platform_data;
...
MODULE_ALIAS("platform:nxp4330-ohci");
